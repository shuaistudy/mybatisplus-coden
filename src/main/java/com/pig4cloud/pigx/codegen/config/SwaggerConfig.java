...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                // 自行修改为自己的包路径
                .apis(RequestHandlerSelectors.basePackage("com.pig4cloud.pigx.codegen"))
                //.apis(RequestHandlerSelectors.basePackage("com.geyecloud.cic.system.setting.device.controller"))
